...
`
  ...
  },
  {
    ...
    details: [
      {
        title: "Orientação Saúde + Telemedicina",
        text: "A Benemed Saúde oferece o serviço de Orientação Saúde + Telemedicina, disponível 24 horas por dia, todos os dias da semana. O atendimento é realizado de forma online, por profissionais de enfermagem e médicos qualificados, garantindo agilidade e comodidade no cuidado com a saúde..."
      },
      {
        title: "Descontos em medicamentos",
        text: "A Assistência de Medicamentos Benemed Saúde oferece descontos de até 80% sobre o Preço Máximo ao Consumidor (PMC)*..."
      },
      {
        title: "Descontos em consultas e exames",
        text: "Com o Agendamento Saúde Benemed, você tem acesso a consultas, exames, procedimentos médicos..."
      },
      {
        title: "Assistência Residencial",
        text: "Para os problemas do dia a dia! • Manutenção e reparos gratuitos; • Assistência 24h..."
      },
      {
        title: "Assistência PET",
      ...
      },
      {
        ...
        text: "O Check-up Completo Benemed Saúde foi desenvolvido para facilitar o cuidado preventivo com a sua saúde..."
      },
      {
        title: "Acidentes Pessoais R$ 10 mil",
        text: `O Seguro de Acidentes Pessoais Benemed Saúde oferece proteção e tranquilidade para o dia a dia, garantindo segurança financeira em casos de imprevistos.
...
`
  ...
  },
  {
    ...
    details: [
      ...
      {
        title: "Check-up completo",
        text: "O Check-up Completo Benemed Saúde foi desenvolvido para facilitar o cuidado preventivo..."
      },
      {
        title: "Acidentes Pessoais R$ 10 mil",
        text: `O Seguro de Acidentes Pessoais Benemed Saúde oferece proteção e tranquilidade para o dia a dia, garantindo segurança financeira em casos de imprevistos.
